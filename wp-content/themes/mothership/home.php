...
<article>
	<div class="post-title">
		<h2><a href="<?php the_permalink(); ?>" title="View Post"><?php the_title(); ?></a></h2>
			<div class="row"><div class="team-image large-1 columns"><?php echo get_wp_user_avatar(get_the_author_meta('ID'), 'thumbnail');  ?></div><p class="author eleven columns end"><em>posted by: </em><?php the_author_posts_link(); ?> on <?php echo the_date('F j, Y', '<em>','</em>', true); ?></p></div>
	</div>
