...
if($i % $columns == 1){ 
	...
	$team_list .= '<li class="'.writeOutNum(12/$columns).' columns panel"><div class="flex-video twelve columns">'.$team_stream.'</div><div class="team-details twelve columns"><a class="" title="View the Team Profile Page" href="'. $team_profile_url.'" class="team-link"><h6>'. $display_name. '</h6></a><p class="team-location ">'.$team_location.'</p></div></li>';
	$i++;
}
$team_list .= '</ul>';
}
