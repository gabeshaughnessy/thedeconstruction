...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${_contraption}", "click", function(sym, e) {
         
         sym.getSymbol("contraption").play();
   ...
   (function(symbolName) {   
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 3250, function(sym, e) {
         console.log(sym.getSymbol("man-on-trike").play(0));
         sym.getSymbol("man-on-trike").play(0);

      });
      //Edge binding end

      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 4250, function(sym, e) {
         sym.getSymbol("man-on-trike").play();
